...
En este caso, dado que ya nos hemos apoyado en Node, se sugiere un pequeño código JavaScript, para ejecutarlo en Node. Se sugiere crear un directorio para este proposito, por ejemplo `C:\Users\MiUsuario\CarpetaLocal\Delegate`; en esta carpeta crearemos el siguiente archivo JavaScript (por ejemplo `app.js`):
